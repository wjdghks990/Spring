...
<script type="text/javascript">
	...
	function send(f) {
		...
		f.action = "modify.do?b_idx=${ vo.b_idx }";
		f.submit();
	}
	...
	<div id="box">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div>
					<h4>제목 :</h4> <input class="form-control" name="b_subject" value="${ vo.b_subject }">
				</div>
				<div>
					<h4>내용 :</h4> <textarea class="form-control" rows="10" name="b_content" value="${ vo.b_content }"></textarea>
				</div>
